...
console.log(students2) // 결과값 : ['김사', '김오', '김육']
// 두 번째 argument는 종료 인덱스 넘버이다.

// filter()
/*
  filter() 메서드를 활용하여 words 배열 내에 있는 단어의 길이가 5 이상인 애들만 추출해서 새로운 배열을 만들어 console에 출력하도록 하겠다.
*/
let words = ['부산광역시', '부산시', '서울특별시', '서울', '경상남도 남해시', '광주광역시', '경기도 광주시', '오사카부 오사카시', '오사카'];
...
/*
  ...
  이상에서 주의할 점은 persons를 가지고 새로운 배열을 만들었는데, persons의 element의 자료형은 object이므로, 새로운 배열인 pass인 element도 여전히 object이다.
